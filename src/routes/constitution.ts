...
constitutionRoutes.get('/rules', (c) => {
  return c.json({
    ...
    add_ons: [
      ...
      { id: 10, name: 'Founder-Investor AI Matchmaking', status: 'Active' },
      { id: 13, name: 'Bankruptcy Reverse Auction', status: 'Active' },
      { id: 14, name: 'Cross-Project Skill Barter Exchange', status: 'Active' },
      { id: 15, name: 'GAFI API Integration', status: 'Active' },
    ...
    ai_modules: [
      ...
      'Dispute Prediction AI (conflict risk 0-100, early warning >65%)',
      'Market Intelligence AI (sector benchmarks, comparable valuations)',
      'Bankruptcy Auction AI (health <20 trigger, asset valuation, distribution waterfall)',
      'Skill Barter Valuation AI (reputation-weighted credit pricing)',
      'Financial Reporting AI (runway prediction, shortfall alerts, 12-month growth)',
      'Board Agenda AI (dynamic agenda based on project state)',
      'Board Performance Evaluation AI (annual, weighted scoring)',
      'Contract Compliance AI (risk score 0-100, renewal tracking)',
      'Law Firm Performance AI (SLA compliance, notarization accuracy)',
      'Early Warning System AI (yellow/red alerts, auto-freeze >70% fraud)',
      'Employee Health Score AI (key-person risk, hiring-freeze trigger)',
      'Matchmaking AI (compatibility 0-100, 48h priority allocation)'
    ],
